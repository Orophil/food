        ...
        <>
          <div className="details_linkBar">
            <span onClick={() => navigate(-1)} className="details_backLink">
              <HiArrowRight />
              {state.lng === "PR" ? "பின்னோக்கி போ" : "Back"}
            </span>
          </div>
          <div className="datails_card">
            <div className="image_box">
              <img
                ...
                alt="card_image"
              />
              <img src="https://cdn-icons-png.flaticon.com/512/89/89975.png" alt="kg" className="kg_image" />
            </div>
            <div className="main_content_box">
              ...
              <div className="card_information">
                <ul>
                  <li>
                    {state.lng === "PR" ? "  ஆர்கானிக்: ஆம்" : "Organic: Yes"}
                  </li>
                  <li>
                    {state.lng === "PR"
                      ? " தொகுப்பு எடை: ஒரு கிலோ"
              ...
              {checkBasket ? (
                ...
                <button
                  ...
                  className="card_buy"
                >
                  {state.lng === "PR" ? " பெட்டகத்தில் சேர்" : "add to cart"}
                </button>
              )}
            </div>
          </div>
